...
<head>
    ...
    <script type="text/javascript" src="https://app.sandbox.midtrans.com/snap/snap.js"
        data-client-key="SB-Mid-client-amBwa0Zs7RgOiSgp"></script>
    <meta name="viewport" content="width=device-width, initial-scale=1.0" />
    <title>Transaksi | POJOK GARASI</title>
...
<body>
                ...
                <table class="table table-bordered table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{ ($i->product->berat * $i->jumlah)/1000 }} Kg</td>
                            <td>{{ $i->jumlah }}</td>
                        ...
                        <tr>
                            ...
                            <input type="hidden" name="total-belanja" id="total-belanja" value="{{ $total }}">
            ...
            <div class="row">
                <div class="col-md-8">
                    ...
                    <div class="mb-3">
                        ...
                        <select name="province_id" id="province_id" class="form-control" onchange="show_kabupaten()">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="alamat" id="alamat" cols="120" required
                ...
                <div class="col-md-4">
                    <div id="load-ongkir"></div>
                </div>
                <button class="btn btn-primary" id="cekOngkir">Cek Ongkir</button>
                <button class="btn btn-primary" id="bayar" style="display: none;">Submit</button>
                    ...
                    <div class="row">
                        <div class="col-4">
                            ...
                            <li class="ms-3 nav-link">
                                ...
                                <a class="text-muted" href="instagram.com">
                                    <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="35" height="35"
                                        viewBox="0 0 50 50" style=" fill:#000000;">
                                        <path
                                ...
                                <a class="text-muted" href="whatsapp.com">
                                    <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="35" height="35"
                                        viewBox="0 0 50 50" style=" fill:#000000;">
                                        <path
    ...
    <script>
        $('#cekOngkir').click(function(e) {
            let table = $('#total-belanja').val();
            if (table == 0) {
                Swal.fire('Keranjang Anda Kosong');
            ...
            if ( kota_id === '' || courier === '') {
            Swal.fire('Harap isi semua field form');
            return;
            }
            let data = {
            kota_id: kota_id,
            ...
            $.ajax({
                ...
                data: data,
                    success: function(response) {
                        $('#load-ongkir').html(response);
                        document.getElementById('cekOngkir').style.display = 'none'; // Menyembunyikan tombol "Cek Ongkir"
                        document.getElementById('bayar').style.display = 'inline-block'; // Menampilkan tombol pengiriman formulir
                    },
        ...
        function show_kabupaten() {
            ...
            success: function(data) {
                ...
                $('#kota_id').append('<option value="' + val.id + '">' + val.type +' '+ val.city_name + '</option>');
                });
        ...
        $('#bayar').click(function(e){
            ...
            $.ajax({
                url: '{{ route('checkout.create_snap_token') }}',
                type: 'POST',
                data: formData,
                processData: false,
                contentType: false,
                ...
                success: function(data) {
                    ...
                    onSuccess: function(result){
                        ...
                        window.location.href = '/transaksi-detail';
                    },
